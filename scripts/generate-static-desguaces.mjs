...
function render(d) {
  ...
  const actionLinks = [
    phone ? `<a href="tel:${escapeHTML(phone)}" aria-label="Llamar al ${escapeHTML(formatPhoneDisplay(phone))}">${escapeHTML(formatPhoneDisplay(phone))}</a>` : '',
