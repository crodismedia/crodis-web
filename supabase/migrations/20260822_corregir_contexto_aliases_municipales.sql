-- Resuelve el municipio oficial de una ficha usando también las pedanías,
-- barrios y núcleos registrados en municipio_aliases.
...
select
  ...
  coalesce(
    (
      select b.total_resultados
      from public.buscar_talleres_municipio(
        me.codigo_municipal,
        '',
        0,
        1
  ...
  from (
    ...
    where m.activo = true
      ...
      and exists (
        ...
        where public.directorio_normalizar(parte.nombre) =
              a.directorio_ciudad_norm
      )
